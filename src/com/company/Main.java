    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (humanWin) {
                ...
                aiTurn();
//            aiTurnNew(); // не работает блокировка хода, оставила обычный рандом
            printMap();
    ...
    private static boolean checkWin(char symbol) {
        ...
        // *что в других главных диагоналях есть нужное количество символов подряд
        quantitySymbolInRow = 0;
        for (int i = 0; i < DOTS_TO_WIN; i++) {
            if (map[i + 1][i] == symbol || map[i][i + 1] == symbol) {
                quantitySymbolInRow++;
            } else if (quantitySymbolInRow > 0) {
                quantitySymbolInRow = 0;
            }
        ...
        // *что в других побочных диагоналях есть нужное количество символов подряд
        quantitySymbolInRow = 0;
        for (int i = 0; i < DOTS_TO_WIN; i++) {
            if (map[i][DOTS_TO_WIN - i - 1] == symbol) {
                quantitySymbolInRow++;
            } else if (quantitySymbolInRow > 0) {
                quantitySymbolInRow = 0;
            }
